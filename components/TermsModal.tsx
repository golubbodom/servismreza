      ...
      <div className="relative w-full max-w-3xl rounded-3xl bg-white/90 backdrop-blur-md shadow-2xl border border-white/40 animate-in fade-in zoom-in-95 duration-200 overflow-hidden">
        <div className="flex items-start justify-between gap-4 p-6 sm:p-8 border-b border-slate-200/60">
          <div>
            ...
            <p className="mt-1 text-slate-600 font-medium">
              Kratak pregled pravila korišćenja platforme.
            </p>
          </div>
        ...
        <div className="p-6 sm:p-8 text-slate-700 leading-relaxed">
          <p className="font-medium">
            Servis Mreža je informativna platforma koja pomaže korisnicima da
            pronađu lokalne firme i majstore. Ne pružamo usluge izvođenja radova
            i ne učestvujemo u realizaciji usluge između korisnika i partnera.
          </p>

          <ul className="mt-4 list-disc pl-5 space-y-2 text-sm font-medium text-slate-700">
            <li>Korisnici samostalno kontaktiraju i dogovaraju uslugu sa partnerima.</li>
            <li>Podaci o partnerima služe informativno i mogu se menjati.</li>
            <li>Zabranjena je zloupotreba platforme i objavljivanje netačnih podataka.</li>
          </ul>
